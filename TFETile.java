...
/*
 * toString uses the tier of a TFETile, unlike the original 2048, which uses value, as this 
 * program uses the console to print the board. This makes managing multiple digit numbers without 
 * being able to resize text with an actual GUI very difficult. Using tier instead of value 
